 ...
 */
final class Version20260125015718 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Update to doctrine 4.0 identity generation strategy and adjust messenger indexes';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('COMMENT ON COLUMN known_player.updated_at IS \'\'');
        $this->addSql('COMMENT ON COLUMN known_player.last_used_at IS \'\'');
        $this->addSql('ALTER TABLE player ALTER id ADD GENERATED BY DEFAULT AS IDENTITY');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player ALTER id DROP IDENTITY');
    }
}
